      ...
      <div className="container relative z-10 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-bold font-syne leading-tight tracking-tighter mb-6"
          >
            Frontend Focused.
            <br />
            <span className="text-gradient-primary">Full-Stack Capable.</span>
          </motion.h1>
          ...
          >
            I build pixel-perfect, accessible, and high-performance web experiences with modern technologies and a keen eye for design.
          </motion.p>
